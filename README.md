...
A browser-based tool that measures words per minute (WPM) from an uploaded audio file, then generates a copy-paste analysis report. Everything runs in your browser — no server, no signup.

**Live demo:** https://97115104.github.io/analyze-wps-embodiment

## Features

- **File upload** — drag-and-drop any audio file (MP3, WAV, M4A, OGG, FLAC, WebM); transcribed in-browser by Whisper AI (~40 MB model, cached after first load)
